...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden parallax-bg" 
      style={{ backgroundImage: "url('https://images.unsplash.com/photo-1560520031-3a4dc4e9de0c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2073&q=80')" }}>
          ...
          <div className="flex-1 max-w-2xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Card className="p-5 bg-white/5 backdrop-blur-sm border-gray-800 w-full max-w-md">
                <h3 className="text-lg font-medium mb-3 text-white">Join our exclusive waitlist</h3>
            ...
            <div className="mt-12">
              <Button variant="outline" className="text-white border-gray-700 hover:bg-gray-800" onClick={() => {
            ...
            <Card className="overflow-hidden border border-gray-800 bg-white/5 backdrop-blur-sm text-white">
              <div className="p-4 bg-gradient-to-r from-gray-800 to-gray-700 border-b border-gray-700">
                <div className="flex items-center">
                  ...
                  <h3 className="font-medium text-gray-300 ml-2">Featured Note Listing</h3>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center">
                      <h4 className="text-xl font-bold">Residential 1st Position</h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="font-medium text-white">{formatCurrency(127500)}</p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="font-medium text-green-300">12+ months current</p>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-700">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xl font-bold text-primary">{formatCurrency(115000)}</p>
                      </div>
