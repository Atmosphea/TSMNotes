...
export function Footer2() {
  ...
  return (
    <footer className="bg-black/95 relative mt-12 py-16">
      {/* Gradient background */}
      <div className="absolute inset-0 w-full h-full">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at calc(25%) 25%, hsl(var(--primary)) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at calc(80%) 85%, hsl(var(--primary)/0.5) 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start">
          ...
          <div className="space-y-4 mb-12 md:mb-0">
            ...
            <p className="text-gray-300 max-w-xs">
              Reach out to us about note trading opportunities, partnerships
          ...
          {/* Right side */}
          <div className="flex flex-wrap gap-8 text-gray-300 justify-start md:justify-end mt-4">
            <Link
              href="/marketplace"
        ...
        <div className="border-t border-gray-800 mt-12 pt-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-400">
            © 2025 NoteTrade. All rights reserved.
          </p>
